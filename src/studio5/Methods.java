...
public class Methods {
	...
	public static void drawBullsEye(double x, double y, double radius) {
	    ...
	    StdDraw.setPenColor(146, 0, 0); // Blue color
	...
	/**
	 * Return an mean value of an array
	 * 
	 * @param the mean of the array we want to calculate
	 * @return mean value of an array
	 */
	public static double arrayMean(int[] value) {
		return arraySum(value)*1.0/value.length;
